  ...
  useEffect(() => {
          ...
          const onEnter = () => {
            ...
            if (src) {
              ...
              tip.innerHTML = [
                ...
                '<a href="' + (src.url || '#') + '" target="_blank" rel="noopener noreferrer" style="color:#0a66c2;text-decoration:none;margin-bottom:8px;display:block;font-weight:600;">View Source →</a>',
    ...
    const openOverlay = (idx: string, src: any) => {
      ...
      modal.innerHTML = [
        ...
        '<a href="' + (src.url || '#') + '" target="_blank" rel="noopener noreferrer" style="display:inline-block;color:#0a66c2;text-decoration:none;margin-bottom:12px;font-size:14px;font-weight:600;">View Source →</a>',
