...
const PostHITL: React.FC<PostHITLProps> = ({ args, respond }) => {
  ...
  const set = (k: keyof LinkedInPostRequest, v: any) =>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              set(
                "max_length",
                parseInt(e.target.value) || DEFAULT_LINKEDIN_POST_MAX_LENGTH,
              )
            }
            style={{
              width: "100%",
          ...
          <div style={{ marginTop: 4, fontSize: 12, color: "#64748b" }}>
            Default {DEFAULT_LINKEDIN_POST_MAX_LENGTH} keeps posts near the “see
            more” soft limit; LinkedIn hard max is 3,000. Longer posts are
            allowed if you raise this.
          </div>
        </div>
      </div>
