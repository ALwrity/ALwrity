...
export const EngagementCard: React.FC<EngagementCardProps> = React.memo(
  ({ opportunities, dataSourceSummary, onGeneratePost }) => {
...
const EngagementRow: React.FC<EngagementRowProps> = React.memo(
  ({ item, index, copied, onCopy, onDismiss, onGeneratePost }) => {
    return (
      <div style={rowBase}>
        <div style={{ marginBottom: 8 }}>
          ...
          >
            ...
            <span
              style={{
                background: (
                  CONFIDENCE_COLORS[item.confidence] || CONFIDENCE_COLORS.medium
                ).bg,
                color: (
                  CONFIDENCE_COLORS[item.confidence] || CONFIDENCE_COLORS.medium
                ).text,
