  ...
  ({
    ...
    if (!dimensions || dimensions.length === 0) {
      return (
        <EmptyState
          icon="🏆"
          message="Brand scorecard data not available. Connect your LinkedIn account for a full analysis."
        />
      );
    }
    ...
    return (
      <div style={cardBase}>
        <div style={headerRow}>
          ...
          {onDismiss && (
            <button
              ...
              style={dismissBtn}
              title="Dismiss"
              aria-label="Dismiss brand scorecard"
            >
              ✕
            </button>
          )}
        ...
        >
          ...
          <div
            style={{ fontSize: 13, color: colors.textBody, lineHeight: 1.5 }}
          >
            💡 {topRecommendation}
          </div>
        </div>
