  ...
  <div className="linkedin-profile-optimise-hover-wrap">
    ...
    {showPopover && profileStrengthPercent != null && (
      <div className="linkedin-profile-optimise-hover-tracker" role="tooltip">
        <p className="linkedin-profile-optimise-hover-title">
          LinkedIn Profile
        </p>
...
export const LinkedInConnectedProfileCard: React.FC<
  LinkedInConnectedProfileCardProps
> = ({
  displayName,
  avatarUrl,
  onDisconnect,
  ...
  const [dismissedDisconnectError, setDismissedDisconnectError] = useState<
    string | null
  >(null);
          ...
          >
            {onOptimiseProfile && (
              <ProfileOptimiseHoverHint
                ...
                strengthTooltip={strengthTooltip}
                showPopover={
                  !isOptimiseLoading && profileStrengthPercent != null
                }
              >
                <button
                  type="button"
                  ...
                  aria-label={
                    isOptimiseLoading
                      ? "Optimising profile"
                      : "LinkedIn Profile — Optimise profile"
                  }
                >
                  {isOptimiseLoading ? "…" : "✦"}
                </button>
            ...
            >
              <div
                ...
                style={{
                  ...
                  borderRadius: 999,
                  background:
                    "radial-gradient(ellipse at center, rgba(10,102,194,0.22) 0%, rgba(10,102,194,0) 72%)",
                  filter: "blur(2px)",
                  pointerEvents: "none",
                  zIndex: 0,
                }}
            ...
            <button
              ...
              title={
                isOptimiseLoading
                  ? "Optimising profile..."
                  : strengthTooltip ||
                    "Optimise profile based on LinkedIn best practices"
              }
              aria-label={
                isOptimiseLoading ? "Optimising profile" : "Optimise profile"
              }
            >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 6px 16px rgba(127,29,29,0.2)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
                  "0 4px 14px rgba(127,29,29,0.12)";
              }}
            >
              <span
                aria-hidden
