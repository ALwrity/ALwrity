...
export const GroundingDataDisplay: React.FC<GroundingDataDisplayProps> = ({
  ...
  return (
    ...
    >
      ...
      {citations.length > 0 && (
        <div>
          ...
          >
            ...
            >
              The content above includes {citations.length} inline{" "}
              {citations.length === 1 ? "citation" : "citations"} linking to
              research sources. Hover over <sup>[N]</sup> markers in the text
              for details.
            </div>
            <div
              style={{
      ...
      >
        Content generated with AI using real-time web research. Claims backed by
        verifiable sources.
      </div>
    </div>
  );
