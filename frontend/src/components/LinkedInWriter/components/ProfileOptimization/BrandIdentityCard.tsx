...
interface BrandIdentityCardProps {
  ...
  className?: string;
  /** Render the strength message. Default true. */
  showStrengthMessage?: boolean;
}
...
export const BrandIdentityCard: React.FC<BrandIdentityCardProps> = ({
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: 13, color: "#64748b" }}>
              Complete your LinkedIn profile to unlock AI-detected positioning
              insights.
            </p>
          </div>
        </div>
  ...
  const hasIdentityData = Boolean(
    professional_identity && professional_identity !== "Unknown",
  );
      ...
      <div className="profile-opt-brand-strip">
        ...
        >
          ...
          <span className="profile-opt-brand-strip__copy">
            <span className="profile-opt-brand-strip__title">
        ...
        {expanded && (
          <div className="profile-opt-brand-strip__details">
            {hasIdentityData && (
              <p className="profile-opt-brand-strip__identity">
                {displayIdentity}
              </p>
            )}
            ...
            {(topExpertise || (industry && industry !== "Unknown")) && (
              <div className="profile-opt-brand-strip__tags">
                {topExpertise && (
                  <span className="profile-opt-brand-strip__tag">
                    {topExpertise}
                  </span>
                )}
            ...
            <p className="profile-opt-brand-strip__strength">
              {strengthMessage}
            </p>
          </div>
        )}
  ...
  return (
    <div
      className={["profile-opt-brand-identity-card", className]
        .filter(Boolean)
        .join(" ")}
      style={{
        padding: "18px 20px",
    ...
    >
      <div style={{ marginBottom: 12 }}>
        ...
        >
          ALwrity analyzed your experience, skills, and positioning to
          understand who you are professionally.
        </p>
      </div>
      ...
      >
        ...
        {!hasIdentityData &&
          ...
          !primaryAudience && (
            ...
            >
              AI analysis in progress — check back in a moment for your complete
              professional identity breakdown.
            </p>
          )}
      </div>
