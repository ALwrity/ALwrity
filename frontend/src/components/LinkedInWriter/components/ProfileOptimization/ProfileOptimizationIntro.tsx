...
export const ProfileOptimizationIntro: React.FC<
  ProfileOptimizationIntroProps
> = ({ isRunning = false, onRunOptimization }) => (
  <div style={{ ...linkedInPlaceholderCardStyles.wrapper, marginTop: 16 }}>
    ...
    >
      ...
      >
        We compare your headline, summary, experience, skills, and other
        sections against LinkedIn best practices — then suggest five high-impact
