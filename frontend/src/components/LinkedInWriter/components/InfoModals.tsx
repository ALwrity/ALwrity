          ...
          <div style={infoModalOverlayStyle}>
            ...
            >
              ...
              <div style={{ textAlign: "left" }}>
                ...
                >
                  ALwrity Co-Pilot is an advanced AI assistant that provides
                  comprehensive support for all your content creation needs. It
                  combines multiple AI capabilities to help you create, edit,
                  and optimize content across various formats.
                </p>
                ...
                >
                  <li>
                    Generate LinkedIn posts, articles, carousels, and video
                    scripts
                  </li>
                  <li>
                ...
                >
                  Click the ALwrity Co-Pilot icon in the bottom-right corner of
                  your screen to open the chat interface. You can then ask for
                  help with any content creation task, and the AI will guide you
                  through the process.
                </p>
            ...
            >
              ...
              <div style={{ textAlign: "center", marginBottom: "24px" }}>
                ...
                <p style={{ margin: 0, color: "#4a5568", fontSize: "16px" }}>
                  Real-time AI writing assistance with research-backed
                  suggestions
                </p>
              </div>
              ...
              <div style={{ textAlign: "left" }}>
                ...
                >
                  Assistive Research Writing provides real-time, contextual
                  writing suggestions as you type. It combines AI-powered
                  content generation with web research to provide accurate,
                  up-to-date information and suggestions that enhance your
                ...
                >
                  Enable Assistive Writing in the editor settings. Once enabled,
                  start typing your content. After typing 5+ words and pausing
                  for 5 seconds, you'll receive contextual writing suggestions.
                  You can accept, dismiss, or request more suggestions as
                  needed.
                </p>
          ...
          <div style={infoModalOverlayStyle}>
            ...
            >
              ...
              <div style={{ textAlign: "left" }}>
                ...
                >
                  <li>
                    <strong>Select Text:</strong> Highlight any claim or
                    statement in your content
                  </li>
                  <li>
                    <strong>AI Analysis:</strong> Our AI extracts key claims and
                    identifies fact-checkable statements
                  </li>
                  <li>
                    <strong>Web Search:</strong> Search for evidence using
                    Exa.ai and Google Search
                  </li>
                  <li>
                    <strong>Verification:</strong> Compare claims against
                    reliable sources and evidence
                  </li>
                  <li>
                    <strong>Results:</strong> Get detailed analysis with
