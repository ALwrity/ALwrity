...
export const EmptyState: React.FC<EmptyStateProps> = React.memo(
  ({ onRefresh, refreshing }) => (
    ...
    >
      ...
      >
        We did not receive any posts from your LinkedIn personal profile. Try
...
export const IdleState: React.FC<{ onFetch: () => void }> = React.memo(
  ({ onFetch }) => (
    <div
      style={{
        border: `1px dashed ${colors.dashedBorder}`,
    ...
    >
      ...
      >
        Load your recent LinkedIn posts with reactions, comments, and
        impressions.
      </p>
