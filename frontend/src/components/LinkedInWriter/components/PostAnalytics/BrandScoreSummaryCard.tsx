...
function CircleGauge({ score }: { score: number }) {
  ...
  return (
    <svg width={60} height={60} viewBox="0 0 60 60" style={{ flexShrink: 0 }}>
      ...
      <text x={30} y={42} textAnchor="middle" fontSize={6} fill="#94a3b8">
        /100
      </text>
    </svg>
  );
...
export const BrandScoreSummaryCard: React.FC = () => {
  const [scorecard, setScorecard] = useState<BrandScorecardResponse | null>(
    null,
  );
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 12, color: "#64748b" }}>
            Run the Growth Engine to see your personal brand health score across
            5 dimensions.
          </div>
        </div>
        <button
