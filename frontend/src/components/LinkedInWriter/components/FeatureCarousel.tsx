      ...
      >
        ...
        <button
          ...
          style={{
            ...
            cursor: "pointer",
            boxShadow:
              "0 4px 15px rgba(102, 126, 234, 0.4), 0 2px 8px rgba(0,0,0,0.1)",
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow =
              "0 6px 20px rgba(102, 126, 234, 0.6), 0 3px 12px rgba(0,0,0,0.15)";
          }}
          onMouseLeave={(e) => {
              ...
              >
                ...
                >
                  {card.image ? (
                    ...
                    <div style={{ fontSize: "64px" }}>{card.icon}</div>
                  )}
                </div>
        ...
        >
          {Array.from({ length: Math.ceil(featureCards.length / 3) }).map(
            (_, index) => (
              <button
                key={index}
