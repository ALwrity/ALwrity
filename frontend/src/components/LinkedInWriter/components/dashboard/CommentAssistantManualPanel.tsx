...
export const CommentAssistantManualPanel: React.FC<
  CommentAssistantManualPanelProps
> = ({ active, onClose }) => {
          ...
          >
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              ...
              <button
                type="button"
                onClick={() => {
                  pushDraftToStudio(result.reply);
                  onClose();
                }}
                style={{
                  padding: "6px 14px",
