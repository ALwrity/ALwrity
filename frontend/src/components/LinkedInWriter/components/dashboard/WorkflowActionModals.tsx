    ...
    <>
      ...
      <DashboardActionModal open={activeModal === 'analysis'} title="Analysis" onClose={onClose} maxWidth={720}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
          ...
          <DashboardToolTile title="Engagement Since You Joined ALwrity" description="Track growth since you joined — Top, Rising, and Falling posts" icon="📈" accent="#16a34a" onClick={() => { onClose(); setAnalysisSub('trends'); }} />
