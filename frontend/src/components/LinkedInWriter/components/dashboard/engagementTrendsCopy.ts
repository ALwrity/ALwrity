...
export const EMPTY_COPY = {
  ...
  notConnectedDescription:
    "Connect your LinkedIn account first to see how your posts are growing.",
...
export const BASELINE_REASON_COPY: Record<string, string> = {
  no_snapshots:
    "We do not have saved snapshots yet. Sync your posts to start tracking growth.",
  ...
  no_current_posts:
    "No saved posts yet. Sync your LinkedIn posts to load growth.",
};
