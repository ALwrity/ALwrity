  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{ fontWeight: 600, color: colors.textDark, marginBottom: 4 }}
          >
            Post
          </div>
          {post.text
          ...
          {post.comments_delta > 0 && (
            ...
            >
              +{post.comments_delta} new comment
              {post.comments_delta === 1 ? "" : "s"} since last sync
            </div>
          )}
        </div>
            ...
            <div style={{ opacity: refreshing ? 0.6 : 1 }}>
              ...
              {comments.map((c) => (
                <PostCommentCard
                  ...
                  replyError={
                    selectedCommentId === c.id ? replyError : undefined
                  }
