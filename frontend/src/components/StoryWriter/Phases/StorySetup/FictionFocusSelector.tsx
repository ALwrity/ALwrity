...
interface FictionFocusSelectorProps {
  options: FocusOption[];
  value: string | null;
...
export const FictionFocusSelector: React.FC<FictionFocusSelectorProps> = ({
  options,
  value,
  onChange,
}) => {
  return (
    <Box sx={{ p: 2, borderRadius: 2, border: '1px solid rgba(148,163,184,0.4)', bgcolor: '#ffffff' }}>
      ...
      <Typography variant="body2" sx={{ mb: 1.5, color: '#4b5563', fontSize: '0.8rem' }}>
        Choose the narrative approach that best suits your story.
      </Typography>
