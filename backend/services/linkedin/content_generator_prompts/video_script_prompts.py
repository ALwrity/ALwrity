...
class VideoScriptPromptBuilder:
    ...
    # resolve_persona_context(user_id, 'linkedin') in the video-script generate
    # method (mirror generate_grounded_post_content). Same pattern as the
    # carousel builder below.
    # ==========================================================================
    @staticmethod
