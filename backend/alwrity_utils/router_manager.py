...
CORE_ROUTER_REGISTRY = [
    ...
    {"name": "subscription", "module": "api.subscription", "attr": "router", "features": {"all", "core", "podcast", "blog_writer", "youtube", "linkedin"}},
    ...
    {"name": "linkedin_profile_edit", "module": "api.linkedin_profile_edit_routes", "attr": "router", "features": {"all", "core", "linkedin"}},
    {"name": "linkedin_analytics", "module": "api.linkedin_analytics_routes", "attr": "router", "features": {"all", "core", "linkedin"}},
    {"name": "linkedin_search", "module": "api.linkedin_search_routes", "attr": "router", "features": {"all", "core", "linkedin"}},
    {"name": "linkedin_avatar_proxy", "module": "api.linkedin_avatar_proxy_routes", "attr": "router", "features": {"all", "core", "linkedin"}},
    {"name": "linkedin_profile_photo", "module": "api.linkedin_profile_photo_routes", "attr": "router", "features": {"all", "core", "linkedin"}},
    {"name": "linkedin_publish_accounts", "module": "api.linkedin_publish_accounts_routes", "attr": "router", "features": {"all", "core", "linkedin"}},
    {"name": "linkedin_oauth_connection", "module": "api.linkedin_oauth_connection_routes", "attr": "router", "features": {"all", "core", "linkedin"}},
    ...
    {"name": "linkedin_comment_assistant_draft", "module": "api.linkedin_comment_assistant_draft_routes", "attr": "router", "features": {"all", "core", "linkedin"}},
    {"name": "brainstorm", "module": "api.brainstorm", "attr": "router", "features": {"all", "core", "linkedin", "youtube"}},
...
OPTIONAL_ROUTER_REGISTRY = [
    ...
    {"name": "content_assets", "module": "api.content_assets.router", "attr": "router", "features":  {"all", "linkedin", "podcast", "blog_writer", "youtube"}},
