...
def _build_workflow_payload(user_id: str, plan: DailyWorkflowPlan, tasks: list[DailyWorkflowTask]) -> Dict[str, Any]:
    ...
    return {
        ...
        "plan": {
            ...
            "meeting_timestamp": plan_json.get("meeting_timestamp") or (plan_json.get("meeting_preflight", {}) or {}).get("checked_at"),
            ...
            "guardian_health": ((plan_json.get("guardian_review") or {}).get("summary") or {}).get("health_score"),
